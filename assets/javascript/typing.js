...
!function(a, b) {
    ...
    function b(a) {
        var b = a;
        return b.strings = a.strings || ["Put your string here...", "and Enjoy!"],
    ...
    function e(a) {
        l(a._props.strings, function(b, c, d) {
            var e = a._props.typeSpeed * b.length - 1;
            a._props.backSpeed < a._props.typeSpeed ? e -= (a._props.typeSpeed - a._props.backSpeed) * b.length : a._props.backSpeed > a._props.typeSpeed && (e += (a._props.backSpeed - a._props.typeSpeed) * b.length);
            var f = this.async()
    ...
    function j(a, b, c, d) {
        return new Promise(function(e, f) {
            var g = b.length;
            c + 1 === d ? a._props.loop ? a._props.loop && i(a, b, g, e) : (void 0 !== a._props.onFinished && "function" == typeof a._props.onFinished && a._props.onFinished(),
            a.innerHTML = b) : c + 1 !== d && i(a, b, g, e)
        }
        )
    }
    function k(a) {
    ...
    return n.classList.add("ityped-cursor"),
    n.textContent = "|",
    {
        init: c,
        destroy: k
